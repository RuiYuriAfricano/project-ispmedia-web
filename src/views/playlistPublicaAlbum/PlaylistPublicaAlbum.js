    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                ...
                if (filtro.length > 0) {
                    setSelectedVideo(`http://localhost:3333/musica/downloadMusica/${filtro[0].codMusica}`);
                    setSelectedUrlCapa(`http://localhost:3333/musica/downloadCapa/${filtro[0].codMusica}`);
